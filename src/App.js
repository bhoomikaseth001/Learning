...
const LedgerNexusApp = () => {
    ...
    const predictFraud = () => {
        ...
        if (fraudValue > 100 || fraudGas > 100000) {
            setFraudPrediction('⚠ Suspicious Transaction Detected!');
        } else {
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <Tabs defaultValue="wallet" className="w-full">
                    ...
                    <TabsContent value="fraud">
                        <Card>
                            ...
                            <CardContent>
                                ...
                                {fraudPrediction && (
                                    <Alert
                                        variant={fraudPrediction.startsWith('⚠') ? 'destructive' : 'default'}
                                        className={cn(
                                            "mt-4",
                                            fraudPrediction.startsWith('⚠')
                    ...
                    <TabsContent value="about">
                        <Card>
                            <CardHeader>
                                <CardTitle className="text-2xl">🖋 About Ledger Nexus</CardTitle>
                            </CardHeader>
